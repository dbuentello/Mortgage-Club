...
module Docusign
  class Base
    ...
    # Docusign::Base.new.create_envelope_from_template(template_name: "Loan Estimate", email_subject: "New test 01/07/2015", user: {name: "Hoang", email: "le_hoang0306@yahoo.com.vn"}, values: { phone: "0906944722" })
