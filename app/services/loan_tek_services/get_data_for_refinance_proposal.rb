...
module LoanTekServices
  class GetDataForRefinanceProposal
    ...
    attr_reader :property_value, :loan_amount, :zipcode, :original_interest_rate
    ...
    def initialize(property_value, loan_amount, zipcode, original_interest_rate)
    ...
    def call
      ...
      {
        new_interest_rate: get_interest_rate(desired_quote),
