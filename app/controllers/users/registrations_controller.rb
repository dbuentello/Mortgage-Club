  ...
  def update
    ...
    if resource_updated
      if is_flashing_format?
        ...
        message = update_needs_confirmation?(resource, prev_unconfirmed_email) ? t("users.registrations.update.confirmation_needed") : t("messages.info.success", status: t("common.status.updated"))
      end
      sign_in resource_name, resource, bypass: true
