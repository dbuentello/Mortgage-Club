...
class BorrowerDocument < ActiveRecord::Base
  ...
  DOCUMENT_LIST = %w(FirstW2 SecondW2 FirstPaystub SecondPaystub FirstBankStatement SecondBankStatement FirstPersonalTaxReturn SecondPersonalTaxReturn FirstBusinessTaxReturn SecondBusinessTaxReturn OtherBorrowerReport)
