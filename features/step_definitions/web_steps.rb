...
When(/^I am at loan management page$/) do
  many_steps %(
    Given there is a borrower_user_with_borrower with the email "testing@man.net" and the password "secretpass" and the password confirmation "secretpass"
      ...
      And there is a address with the street address "1722 Silver Meadow Way" and the street address2 "Apt. 305" and the city "Sacramento" and the state "CA" and the zip "95829" and the full text "1722 Silver Meadow Way, Sacramento, CA 95829" with the property above
...
When(/^I am at dashboard page$/) do
  many_steps %(
    Given there is a borrower_user_with_borrower with the email "testing@man.net" and the password "secretpass" and the password confirmation "secretpass"
      ...
      And there is a address with the street address "1722 Silver Meadow Way" and the street address2 "Apt. 305" and the city "Sacramento" and the state "CA" and the zip "95829" and the full text "1722 Silver Meadow Way, Sacramento, CA 95829" and the property id "be69aefe-3946-4b85-9c54-58dd51306b1c"
