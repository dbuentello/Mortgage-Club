...
When(/^I am at loan management page$/) do
  many_steps %(
    Given there is a borrower_user_with_borrower with the email "testing@man.net" and the password "secretpass" and the password confirmation "secretpass"
      ...
      And there is a address with the street address "1722 Silver Meadow Way" and the city "Sacramento" and the state "CA" and the zip "95829" and the full text "1722 Silver Meadow Way, Sacramento, CA 95829" with the property above
...
When(/^I am at dashboard page$/) do
  many_steps %(
    Given there is a borrower_user_with_borrower with the email "testing@man.net" and the password "secretpass" and the password confirmation "secretpass"
      And there is a closing with the name "Fake Name"
      And there is a loan with the amount "500000" and with the num of months "24" and with the purpose "0" and with the status "processing" and with the user above and with the closing above and with the monthly_payment "5356"
      ...
      And there is a address with the street address "1722 Silver Meadow Way" and the city "Sacramento" and the state "CA" and the zip "95829" and the full text "1722 Silver Meadow Way, Sacramento, CA 95829" and the property id "be69aefe-3946-4b85-9c54-58dd51306b1c"
...
When(/^I am at loan member dashboard$/) do
  many_steps %(
    Given there is a borrower_user_with_borrower with the email "john_doe@gmail.com" and with the first name "John" and the last name "Doe"
      ...
      And there is a property with the purchase price "1000000" and with the usage "0" and with the is primary "1" and with the is subject "1" and with loan above
      And there is a loan_member_user_with_loan_member with the email "loan_member@mortgageclub.co" and the password "secretpass" and the password confirmation "secretpass" and the first name "Mark" and the last name "Lim"
