      ...
      <div className="col-md-4 loan-item" key={loan.id} index={i}>
        <div className="loan-item-holder">
          <a href={"/my/dashboard/" + loan.id}>
            <img className="img-responsive fixed-height-246" src={this.props.commonInfo[loan.id].zillow_image_url ? this.props.commonInfo[loan.id].zillow_image_url : "/default.jpg"}/>
          </a>
          <div className="caption">
            <a href={"/my/dashboard/" + loan.id}>
              <h6><strong>{this.props.commonInfo[loan.id].address}</strong></h6>
            </a>
