...
var Form = React.createClass({
  ...
  getInitialState: function() {
    ...
    state[fields.propertyValue.keyName] = this.formatCurrency(this.props.bootstrapData[fields.propertyValue.name], 0, "$");
    state[fields.downPayment.keyName] = this.formatCurrency(this.props.bootstrapData[fields.downPayment.name], 0, "$");
    state[fields.mortgageBalance.keyName] = this.formatCurrency(this.props.bootstrapData[fields.mortgageBalance.name], 0, "$");
  ...
  onBlur: function(blur) {
    ...
    if(key == fields.propertyValue.keyName && changedPropertyValue == true) {
      ...
      state[fields.downPayment.keyName] = this.formatCurrency(value, 0, "$");
      this.setState(state);
