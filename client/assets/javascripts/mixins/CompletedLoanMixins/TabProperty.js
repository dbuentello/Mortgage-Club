var TabProperty = {
  ...
  propertyCompleted: function(loan) {
    ...
    if(!this.subjectPropertyCompleted(loan.subject_property)) {
      return false;
    }

    if(!this.purposeCompleted(loan)){
      return false;
    }
  ...
  subjectPropertyCompleted: function(property) {
    ...
    if(property.usage !== "primary_residence" && property.gross_rental_income === null) {
      return false;
    }
