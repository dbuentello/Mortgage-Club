...
var Property = React.createClass({
  ...
  render: function() {
    var uploadUrl = '/document_uploaders/properties/upload';
  ...
  buildStateFromProperty: function(property) {
    ...
    _.map(Object.keys(fields), function(key) {
      ...
      if (this.props.property[key]) { // has a document
        ...
        state[fields[key].name + '_downloadUrl'] = '/document_uploaders/base_document/' + this.props.property[key].id +
                                         '/download?type=' + fields[key].type;
        state[fields[key].name + '_removedUrl'] = '/document_uploaders/base_document/' + this.props.property[key].id +
