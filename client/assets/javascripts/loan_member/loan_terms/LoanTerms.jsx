        ...
        <div className="panel panel-flat terms-view">
          <div>
...

            {
              ...
              ?
              <Form loan={this.props.bootstrapData.loan}
                property={this.props.bootstrapData.property}
                address={this.props.bootstrapData.address}
                property_id={this.props.bootstrapData.property.id}
                address_id={this.props.bootstrapData.address.id}
                loanWritableAttributes={this.props.bootstrapData.loan_writable_attributes}/>
              :
