            ...
            <div className="content-wrapper">
              <div className="tab-content">
                ...
                <div role="tabpanel" className="tab-pane fade" id="loan_terms">
                  <LoanTermsTab loan={sourceData.loan} loanWritableAttributes={sourceData.loan_writable_attributes} property={sourceData.property} address={sourceData.property_address}/>
                </div>
              </div>
            </div>
          </div>
