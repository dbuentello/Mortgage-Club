...
describe RatesComparisonServices::GetRatesFromLenda do
  ...
  before(:each) do
    ...
    allow_any_instance_of(Crawler::LendaRates).to receive(:call).and_return(@rates)
  end

  it "calls Crawler::LendaRates service" do
    expect_any_instance_of(Crawler::LendaRates).to receive(:call)
