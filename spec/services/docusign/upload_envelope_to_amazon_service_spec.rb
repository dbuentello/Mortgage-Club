...
describe Docusign::UploadEnvelopeToAmazonService do
  ...
  #       expect(Docusign::DownloadDocumentService).to receive(:call)
  #       @service.call
  #     end
  #   end

  #   it "calls DocumentServices::UploadFile" do
  #     allow(Docusign::DownloadDocumentService).to receive(:call).and_return(Rails.root.join 'spec', 'files', 'sample.doc')
