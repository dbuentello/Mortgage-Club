...
describe UserForm do
  let(:form) do
    ...
    UserForm.new(params: params, skip_confirmation: true)
  end
  ...
  describe "#save" do
    ...
    context "invalid params" do
      ...
      it "stores error's messages" do
        form.save
        expect(form.errors.full_messages).to eq(["Email is invalid", "Email is invalid", "First name This field is required", "Last name This field is required"])
      end
    end
  end
end
