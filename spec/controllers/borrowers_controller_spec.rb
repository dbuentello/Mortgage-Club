  ...
  describe "GET #update" do
    ...
    before do
      @borrower_params = {"current_address"=>{"street_address"=>"12740 El Camino Real", "street_address2"=>"",
        ...
        "previous_borrower_address"=>{"is_rental"=>"true", "is_current"=>"false"},
        "borrower"=>{"email"=>"borrower@gmail.com", "first_name"=>"John", "middle_name"=>"", "last_name"=>"Doe", "suffix"=>"",
      ...
      @secondary_borrower ={"current_address"=>{"street_address"=>"23 Park Avenue", "street_address2"=>"", "city"=>"New York", "state"=>"NY", "zip"=>"10016", "full_text"=>"23 Park Avenue, New York, NY, United States"},
