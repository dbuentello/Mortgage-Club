...
describe Users::BorrowersController do
  ...
  describe "GET #update" do
    ...
    let(:borrower_params) do
      {
        current_address:
        {
          street_address: "12740 El Camino Real", street_address2: "",
    ...
    let(:secondary_borrower) do
      {
        current_address:
        {
          street_address: "23 Park Avenue", street_address2: "",
        ...
        current_borrower_address:
        {
          is_rental: "true", years_at_address: "4", monthly_rent: "345", is_current: "true"
        },
        previous_borrower_address:
        {
          is_rental: "true", is_current: "false"
        ...
        borrower:
        {
          email: "hfdi@example.com", first_name: "almg", middle_name: "",
