FactoryGirl.define do
  factory :document do |f|
    ...
    factory :borrower_document, parent: :document do |factory|
      ...
      factory.document_type { %w(first_w2 second_w2 first_paystub second_paystub first_bank_statement second_bank_statement
    ...
    factory :property_document, parent: :document do |factory|
      ...
      factory.document_type { %w(appraisal_report flood_zone_certification homeowners_insurance
    ...
    factory :loan_document, parent: :document do |factory|
      factory.subjectable { create(:loan) }
      factory.document_type { %w(hud_estimate hud_final loan_estimate uniform_residential_lending_application other_loan_report).sample }
    end

    factory :closing_document, parent: :document do |factory|
      factory.subjectable { create(:closing) }
      factory.document_type { %w(closing_disclosure deed_of_trust loan_doc other_closing_report).sample }
    end
  end
end
